#this script should customize a shapefile map for the locations of where samples of H. baileyi were found
...
sites<-read_xlsx("/Users/abhimehrotra/Desktop/Miller_sponge gps coordinates_summer 2021.xlsx", sheet="Hb")
...
(map1<-map1+
    geom_sf(data=la.c)+
    geom_point(aes(x=Long,y=Lat, color=Hb),data=sites,size=2))
