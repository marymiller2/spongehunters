...
sites<-read_xlsx("map_data_files/Miller_sponge gps coordinates_summer 2021.xlsx", sheet="All Sites")
theme_set(theme_bw())
(map2<-ggmap(la.map.h))
```
