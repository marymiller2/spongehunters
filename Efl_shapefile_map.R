#this script should customize a shapefile map for the locations of where samples of E. fluviatilis were found
...
sites<-read_xlsx("/Users/abhimehrotra/Desktop/Miller_sponge gps coordinates_summer 2021.xlsx", sheet="Efl")
...
(map1<-map1+
    geom_sf(data=la.c)+
    geom_point(aes(x=Long,y=Lat, color=Efl),data=sites,size=2))
