#this script should customize a shapefile map for the locations of where samples of R. ryderi were found
...
sites<-read_xlsx("/Users/abhimehrotra/Desktop/Miller_sponge gps coordinates_summer 2021.xlsx", sheet="Rr")
...
(map1<-map1+
    geom_sf(data=la.c)+
    geom_point(aes(x=Long,y=Lat, color=Rr),data=sites,size=2))
