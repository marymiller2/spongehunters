#this script should customize a shapefile map for the locations of where samples of D. mackayi were found
# Written by Abhi Mehrotra, June 29, 2021
...
sites<-read_xlsx("/Users/abhimehrotra/Desktop/Miller_sponge gps coordinates_summer 2021.xlsx", sheet="Dm")
...
(map1<-map1+
    geom_sf(data=la.c)+
    geom_point(aes(x=Long,y=Lat, color=Dm),data=sites,size=2))
