#this script should customize a shapefile map for the locations of where samples of E. fragilis were found
...
sites<-read_xlsx("/Users/abhimehrotra/Desktop/Miller_sponge gps coordinates_summer 2021.xlsx", sheet="Efr")
