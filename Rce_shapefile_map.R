#this script should customize a shapefile map for the locations of where samples of R. cerebellata were found
...
(map1<-map1+
    geom_sf(data=la.c)+
    geom_point(aes(x=Long,y=Lat, color=Rce),data=sites,size=2))
